...
HD_PWD='D:/miniRV_CTEST_CoreMark_v8/miniRV_lab2_C_TEST0-4_CoreMark_50MHz_v8_MEM_handshake_fixed/miniRV_complete/vivado_c_test_board_50MHz/miniRV_c_test_board_50MHz.runs/clk_wiz_0_synth_1'
cd "$HD_PWD"
