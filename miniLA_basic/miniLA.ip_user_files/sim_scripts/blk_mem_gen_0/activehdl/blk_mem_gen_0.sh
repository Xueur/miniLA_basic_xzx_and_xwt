...
#
# Script generated by Vivado on Mon Jul 27 01:19:56 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Vivado/miniLA_basic_xzx_and_xwt/miniLA_basic/miniLA.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
