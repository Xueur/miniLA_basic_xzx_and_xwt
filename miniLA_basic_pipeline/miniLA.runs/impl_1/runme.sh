...
HD_PWD='D:/Vivado/miniLA_basic_xzx_and_xwt/miniLA_basic_pipeline/miniLA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log miniLA_SoC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source miniLA_SoC.tcl -notrace
