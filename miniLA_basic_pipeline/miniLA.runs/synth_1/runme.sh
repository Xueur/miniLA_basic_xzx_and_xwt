...
HD_PWD='D:/Vivado/miniLA_basic_xzx_and_xwt/miniLA_basic_pipeline/miniLA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log miniLA_SoC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source miniLA_SoC.tcl
